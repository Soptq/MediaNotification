package soptqs.medianotification.dialogs;
...
public class AboutDialog extends AppCompatDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(soptqs.medianotification.R.layout.dialog_about);

        vukView = findViewById(soptqs.medianotification.R.id.vuk);
        contributorView = findViewById(soptqs.medianotification.R.id.contributors);
        maintainerView = findViewById(soptqs.medianotification.R.id.maintainers);
        githubView = findViewById(soptqs.medianotification.R.id.github);
        glideView = findViewById(soptqs.medianotification.R.id.glide);
        markwonView = findViewById(soptqs.medianotification.R.id.markwon);
