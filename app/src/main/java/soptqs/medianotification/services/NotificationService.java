...
public class NotificationService extends NotificationListenerService {
    ...
    public void updateNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "music")
                .setSmallIcon(soptqs.medianotification.R.drawable.ic_music)
...
//                .setStyle(new android.support.v4.media.app.NotificationCompat.MediaStyle())
        ...
        if (appName == null)
            appName = getString(soptqs.medianotification.R.string.app_name);
        ...
        if (smallIcon == null)
            smallIcon = ImageUtils.getVectorBitmap(this, soptqs.medianotification.R.drawable.ic_music);
    ...
    private RemoteViews getContentView(boolean isCollapsed) {
        ...
        remoteViews.setTextColor(soptqs.medianotification.R.id.title, color);
        remoteViews.setTextColor(soptqs.medianotification.R.id.subtitle, color);

        TypedArray typedArray = obtainStyledAttributes(new int[]{android.R.attr.selectableItemBackground});
        int selectableItemBackground = typedArray.getResourceId(0, 0);
        typedArray.recycle();

        remoteViews.setInt(soptqs.medianotification.R.id.content, "setBackgroundResource", selectableItemBackground);
        ...
        for (int i = 0; i < 5; i++) {
            ...
            switch (i) {
                case 0:
                    id = soptqs.medianotification.R.id.first;
                    break;
                case 1:
                    id = soptqs.medianotification.R.id.second;
                    break;
                case 2:
                    id = soptqs.medianotification.R.id.third;
                    break;
                case 3:
                    id = soptqs.medianotification.R.id.fourth;
                    break;
                case 4:
                    id = soptqs.medianotification.R.id.fifth;
                    break;
            }
    ...
    private int getActionIconRes(int i, int actionCount, String... names) {
        for (String name : names) {
            if (contains(name, "play"))
                return contains(name, "pause") ? (isPlaying ? soptqs.medianotification.R.drawable.ic_pause : soptqs.medianotification.R.drawable.ic_play) : soptqs.medianotification.R.drawable.ic_play;
            else if (contains(name, "pause"))
                return soptqs.medianotification.R.drawable.ic_pause;
            else if (contains(name, "prev"))
                return soptqs.medianotification.R.drawable.ic_skip_previous;
            else if (contains(name, "next"))
                return soptqs.medianotification.R.drawable.ic_skip_next;
            else if (contains(name, "stop"))
                return soptqs.medianotification.R.drawable.ic_stop;
            else if (contains(name, "down") || contains(name, "dislike") || contains(name, "unfavorite") || contains(name, "un-favorite"))
                return soptqs.medianotification.R.drawable.ic_thumb_down;
            else if (contains(name, "up") || contains(name, "like") || contains(name, "favorite"))
                return soptqs.medianotification.R.drawable.ic_thumb_up;
            else if (contains(name, "add"))
                return soptqs.medianotification.R.drawable.ic_add;
            else if (contains(name, "added") || contains(name, "check") || contains(name, "new"))
                return soptqs.medianotification.R.drawable.ic_check;
        }
        ...
        if (actionCount == 5) {
            if (i == 0)
                ...
                return isPlaying ? soptqs.medianotification.R.drawable.ic_pause : soptqs.medianotification.R.drawable.ic_play;
            else if (i == 3)
                return soptqs.medianotification.R.drawable.ic_skip_next;
            else if (i == 4)
                return soptqs.medianotification.R.drawable.ic_thumb_down;
        ...
        return soptqs.medianotification.R.drawable.ic_music;
    }
    ...
    private void getAlbumArt(String albumName, String artistName) {
        ...
        try {
            baseUrl = "http://ws.audioscrobbler.com/2.0/?method=album.getInfo"
                    + "&api_key=" + getString(soptqs.medianotification.R.string.last_fm_api_key)
                ...
                if (--persistence < 0 || (playerData != null && playerData.persistence > 0)) {
                    ...
                    if (previousIntent != null) {
                        actions.add(new NotificationCompat.Action(
                                soptqs.medianotification.R.drawable.ic_skip_previous,
                                "Previous",
                                previousIntent
                        ));
                    }
                    ...
                    if (playPauseIntent != null) {
                        actions.add(new NotificationCompat.Action(
                                isPlaying ? soptqs.medianotification.R.drawable.ic_pause : soptqs.medianotification.R.drawable.ic_play,
                    ...
                    if (nextIntent != null) {
                        actions.add(new NotificationCompat.Action(
                                soptqs.medianotification.R.drawable.ic_skip_next,
                                "Next",
                                nextIntent
                        ));
                    }
