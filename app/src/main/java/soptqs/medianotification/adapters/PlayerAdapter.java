package soptqs.medianotification.adapters;
...
public class PlayerAdapter extends RecyclerView.Adapter<PlayerAdapter.BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 3)
            return new TutorialHolder(LayoutInflater.from(parent.getContext()).inflate(soptqs.medianotification.R.layout.item_tutorial_players, parent, false));
        else
            return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(soptqs.medianotification.R.layout.item_app, parent, false));
    }
    ...
    public void onBindViewHolder(final BaseViewHolder holder, int position) {
        ...
        if (viewType == 0) {
            ...
            viewHolder.headerText.setText(soptqs.medianotification.R.string.title_default);
        } else if ((defaultPackage != null && position > 0 && defaultPackage.equals(getPackageName(position - 1))) || position == (isTutorial ? 1 : 0)) {
            viewHolder.header.setVisibility(View.VISIBLE);
            viewHolder.headerText.setText(soptqs.medianotification.R.string.title_supported_players);
                ...
                viewHolder.aboutDefault.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        new AlertDialog.Builder(context)
                                .setTitle(soptqs.medianotification.R.string.title_default_player)
                                .setMessage(soptqs.medianotification.R.string.desc_tutorial_players_default)
            ...
            viewHolder.header.setVisibility(View.VISIBLE);
            viewHolder.headerText.setText(soptqs.medianotification.R.string.title_all);
            ...
            viewHolder.about.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    new AlertDialog.Builder(context)
                            .setTitle(soptqs.medianotification.R.string.title_supported_players)
                            .setMessage(soptqs.medianotification.R.string.desc_tutorial_players_supported)
                            .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    dialogInterface.dismiss();
    ...
    private static class TutorialHolder extends BaseViewHolder {
        ...
        public TutorialHolder(View itemView) {
            super(itemView);
            tutorialOk = itemView.findViewById(soptqs.medianotification.R.id.tutorialOk);
        }
    }
    ...
    private static class ViewHolder extends BaseViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            header = itemView.findViewById(soptqs.medianotification.R.id.header);
            headerText = itemView.findViewById(soptqs.medianotification.R.id.headerText);
            about = itemView.findViewById(soptqs.medianotification.R.id.about);
            icon = itemView.findViewById(soptqs.medianotification.R.id.icon);
            title = itemView.findViewById(soptqs.medianotification.R.id.title);
