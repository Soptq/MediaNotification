package soptqs.medianotification.views;
...
public class AppIconView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.size != size || fgBitmap == null || bgBitmap == null) {
            this.size = size;
            fgBitmap = getRoundBitmap(soptqs.medianotification.R.mipmap.icon_foreground_web, size);
            bgBitmap = getRoundBitmap(soptqs.medianotification.R.mipmap.icon_background_web, size);
        }
